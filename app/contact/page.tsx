  ...
  return (
    <section className='flex flex-col items-center mt-10 mb-16 sm:mb-36' id='projects'>
        ...
        <form className='flex flex-col text-brand-grayHigh mt-12'>
            ...
            <input type="text" name='name' id='name' className='rounded-lg bg-white mb-6 border border-gray-200 w-64 sm:w-96 h-10 px-4 focus:border-brand-yellow focus:border-2 focus:outline-none' />
            <label htmlFor="email" className='text-base mb-2'>{inputEmail}</label>
            <input type="text" name='email' id='email' className='rounded-lg bg-white mb-6 border border-gray-200 w-64 sm:w-96 h-10 px-4 focus:border-brand-yellow focus:border-2 focus:outline-none' />
            <label htmlFor="message" className='text-base mb-2'>{inputMessage}</label>
            <textarea name='message' id='message' className='rounded-lg bg-white mb-6 border border-gray-200 w-64 sm:w-96 h-40 px-4 py-2 resize-none focus:border-brand-yellow focus:border-2 focus:outline-none' />
